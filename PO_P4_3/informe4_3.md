...
```
El codigo muy resimidamente consiste en crear una tarea nueva que llama a la funcion ArduinoOTA que basicamente establece un puerto i una ip donde ser envia el codigo.